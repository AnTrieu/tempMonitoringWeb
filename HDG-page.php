...
<head>
    ...
    <script>
        const MALL_pos = [[1204, 236], [1381, 378], [1693, 226], [2115, 390], [2179, 226]];
        const EB_pos = [[1322, 877], [1671, 563], [1939, 682], [2128, 1090], [2220, 619]];
...
<body class="body_HDG">
    ...
    <div class="horizontal-dashed-line" id="MALL_main_2"></div>
    <div class="vertical-dashed-line"   id="MALL_main_1"></div>
    ...
    <script>
        function downloadFunction(type_sensor, index_sensor)
        {
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("info_outsite").style.top = normalize(448, height_Img, bodyHeight) + 'px'; 
            document.getElementById("info_outsite").style.left = normalize(327, width_Img, bodyWidth) + 'px'; 
        ...
        function draw_MALL(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= MALL_pos.length; sensor++)
            {
                ...
                document.getElementById("MALL_lo_" + sensor).style.top = normalize(745, height_Img, bodyHeight) + 'px';
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                if ((EB_pos[sensor - 1][0] < 0) || 
                    (EB_pos[sensor - 1][1] < 0) || 
                    (document.getElementById("EB_"+ sensor) == null) || 
                    (document.getElementById("EB_circle_"+ sensor) == null) || 
                    (document.getElementById("EB_lo_" + sensor) == null))
                {
                    continue;
                }
                ...
                document.getElementById("EB_lo_" + sensor).style.top = normalize(1042, height_Img, bodyHeight) + 'px';
