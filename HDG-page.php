...
<body class="body_HDG">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("OUT_square_11").style.top = normalize(448, height_Img, bodyHeight) + 'px'; 
            document.getElementById("OUT_square_11").style.left = normalize(327, width_Img, bodyWidth) + 'px'; 
