...
<head>
    ...
    <script>
        const MALL_pos = [[1336, 928], [971, 791], [2397, 1135], [1874, 1057], [2110, 350]];
        const EB_pos = [[2381, 760], [1976, 760], [1976, 945], [2381, 945], [2165, 945]];
...
<body class="body_TNN">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("info_outsite").style.top = normalize(725, height_Img, bodyHeight) + 'px'; 
            document.getElementById("info_outsite").style.left = normalize(34, width_Img, bodyWidth) + 'px'; 
        ...
        function draw_MALL(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= MALL_pos.length; sensor++)
            {
                ...
                document.getElementById("MALL_lo_" + sensor).style.top = normalize(495, height_Img, bodyHeight) + 'px';
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                document.getElementById("EB_lo_" + sensor).style.top = normalize(130, height_Img, bodyHeight) + 'px';
                document.getElementById("EB_lo_" + sensor).style.left = normalize(775 + sensor * (18 + 100), width_Img, bodyWidth) + 'px';
