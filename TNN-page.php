...
<body class="body_TNN">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("OUT_square_11").style.top = normalize(725, height_Img, bodyHeight) + 'px'; 
            document.getElementById("OUT_square_11").style.left = normalize(34, width_Img, bodyWidth) + 'px'; 
