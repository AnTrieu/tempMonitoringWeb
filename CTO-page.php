...
<head>
    ...
    <script>
        const MALL_pos = [[1360, 1188], [1057, 1278], [870, 1150], [1800, 736], [2212, 778]];
        const EB_pos = [[2084, 658], [1976, 516], [1874, 658], [1793, 356], [2086, 223]];
...
<body class="body_CTO">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("info_outsite").style.top = normalize(733, height_Img, bodyHeight) + 'px'; 
            document.getElementById("info_outsite").style.left = normalize(35, width_Img, bodyWidth) + 'px'; 
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                document.getElementById("EB_lo_" + sensor).style.top = normalize(1090, height_Img, bodyHeight) + 'px';
                document.getElementById("EB_lo_" + sensor).style.left = normalize(1725 + sensor * (18 + 100), width_Img, bodyWidth) + 'px';
