...
<body class="body_TBG">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("info_outsite").style.top = normalize(35, height_Img, bodyHeight) + 'px'; 
            document.getElementById("info_outsite").style.left = normalize(745, width_Img, bodyWidth) + 'px'; 
        ...
        function draw_MALL(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= MALL_pos.length; sensor++)
            {
                ...
                document.getElementById("MALL_lo_" + sensor).style.top = normalize(560, height_Img, bodyHeight) + 'px';
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                document.getElementById("EB_lo_" + sensor).style.top = normalize(885, height_Img, bodyHeight) + 'px';
