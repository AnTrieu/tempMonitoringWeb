...
<body class="body_TBG">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("OUT_square_11").style.top = normalize(35, height_Img, bodyHeight) + 'px'; 
            document.getElementById("OUT_square_11").style.left = normalize(745, width_Img, bodyWidth) + 'px'; 
