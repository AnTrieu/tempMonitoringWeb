...
<head>
    ...
    <script>
        const MALL_pos = [[527, 1140], [426, 1258], [718, 1284], [1214, 1140], [1331, 1258]];
        const EB_pos = [[1030, 320], [1230, 230], [1230, 530], [1580, 230], [1580, 530]];
...
<body class="body_HLG">
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("info_outsite").style.top = normalize(723, height_Img, bodyHeight) + 'px'; 
        ...
        function draw_MALL(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= MALL_pos.length; sensor++)
            {
                ...
                document.getElementById("MALL_lo_" + sensor).style.top = normalize(510, height_Img, bodyHeight) + 'px';
