    ...
    <script>
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                document.getElementById("EB_lo_" + sensor).style.top = normalize(1290, height_Img, bodyHeight) + 'px';
                document.getElementById("EB_lo_" + sensor).style.left = normalize(1845 + sensor * (18 + 100), width_Img, bodyWidth) + 'px';
