...
<head>
    ...
    <script>
        const MALL_pos = [[1950, 1000], [344, 1156], [250, 750], [750, 932], [560, 1280]];
        const EB_pos = [[2166, 848], [1840, 848],  [1750, 470], [2208, 470], [1990, 240]];
    ...
    <script>
        ...
        function draw_MALL(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= MALL_pos.length; sensor++)
            {
                ...
                document.getElementById("MALL_lo_" + sensor).style.top = normalize(440, height_Img, bodyHeight) + 'px';
                document.getElementById("MALL_lo_" + sensor).style.left = normalize(-30 + sensor * (18 + 100), width_Img, bodyWidth) + 'px'; 
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                document.getElementById("EB_lo_" + sensor).style.top = normalize(1220, height_Img, bodyHeight) + 'px';
                document.getElementById("EB_lo_" + sensor).style.left = normalize(1590 + sensor * (18 + 100), width_Img, bodyWidth) + 'px';
