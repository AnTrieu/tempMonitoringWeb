...
<head>
    ...
    <script>
        const MALL_pos = [[1450, 920], [622, 992], [1133, 992], [430, 852], [406, 766]];
        const EB_pos = [[2224, 471],  [1977, 449], [1702, 472], [1934, 234]];
...
<body class="body_NTT">
    ...
    <div class="horizontal-dashed-line"   id="MALL_main_1"></div>
    <div class="vertical-dashed-line" id="MALL_main"></div>

    <div class="vertical-line"   id="EB_main_1"></div>
    <div class="horizontal-line" id="EB_main_2"></div>
    <div class="vertical-line"   id="EB_main_3"></div>
    ...
    <script>
        ...
        function draw_onsite(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            ...
            document.getElementById("info_outsite").style.top = normalize(488, height_Img, bodyHeight) + 'px'; 
            document.getElementById("info_outsite").style.left = normalize(46, width_Img, bodyWidth) + 'px'; 
        ...
        function draw_MALL(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= MALL_pos.length; sensor++)
            {
                ...
                document.getElementById("MALL_lo_" + sensor).style.top = normalize(241, height_Img, bodyHeight) + 'px';
                document.getElementById("MALL_lo_" + sensor).style.left = normalize(760 + sensor * (18 + 100), width_Img, bodyWidth) + 'px'; 
        ...
        function draw_EB(width_Img, height_Img, bodyWidth, bodyHeight)
        {
            for(var sensor = 1; sensor <= EB_pos.length; sensor++)
            {
                ...
                document.getElementById("EB_lo_" + sensor).style.left = normalize(1922 + sensor * (18 + 100), width_Img, bodyWidth) + 'px';
        ...
        $(window).load(function() {
            ...
            for (var i = 1; i <= MALL_pos.length; i++) 
            {
                ...
                verticalDashedLine.className = "horizontal-dashed-line";
